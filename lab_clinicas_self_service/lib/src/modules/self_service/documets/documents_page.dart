...
import 'package:lab_clinicas_self_service/src/modules/self_service/documets/widgets/documents_box_widget.dart';
          ...
          child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    visible: totalMedicalOrder > 0 && totalHealthInsuranceCards > 0,
                    child: Row(
                      children: [
                        Expanded(
